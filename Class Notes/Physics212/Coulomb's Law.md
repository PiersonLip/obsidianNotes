...
\begin{eqboxed}{eq:CoulombsLaw}{Coulomb's Law}
    {Gives a force along the line of two charges. \\ If $q_1$ and $q_2$ have the same sign (i.e. charge) then the force must be repulsive. But if they have the *same* sign, then it must be attractive.\\ 
...
![[physics212-coulombs-law-1.png]]

    

![[physics212-coulombs-law-2.png]]

  

  **$F_{1,net$** = F_{21} + F_{31}}
...
>
>
> Using Coulomb's Law[(eq:CoulombsLaw)](#eq:CoulombsLaw)…
>
> $$
>
...
>
> $$
> k = 9 \times 10^9 \frac{NM^2}{C^2},     q_1 = 2\mu C,    q_2 = -1 \mu C,    q_3 = 4\mu C 
> $$
>
>
> $$
> \vec{F_{31}} = $1.800e-02\,\mathrm{mathrm}{m}athrm{N}$,   \vec{F_{32}} = $-3.600e-02\,\mathrm{mathrm}{m}athrm{N}$
> $$
>
>
> $$
> **$\vec{F$**_{3, net} =  $-1.800e-02\,\mathrm{mathrm}{m}athrm{N}$}
> $$
