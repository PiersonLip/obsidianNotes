...
When comparing the theoretical lifespan of them, to the quanity obsreved, we find that they have formation rate of $10^{-7} \text{yr}^{-1}$
- one out of $∼ 10^{5}$ binaries finishes in a LMXB system, whereas [[HMXB]] is *one out of ten* 
...
- This was from an [[SNe]], most likely some sort of [[natal-kick]]
