...
This means that in systems of very dense matter, the system ***{cannot reach homogeneity}***, and thus will actually have an inherent pressure. This pressure can prevent collapse due to gravity in various high dense objects (compact objects in astronomy).
