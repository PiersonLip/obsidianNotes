...
- want angle $\theta$ between opp and east quad
- $\theta = (\omega_{E} - \omega_{p})$ and $C/B =cos\theta$
- measure $\tau$ and synodic period, calculate sidereal period and $\omega_{p}$; know $\omega_{E}$ and infer $C/B$
