---
astrobites-url: https://astrobites.org/2026/05/23/were-going-to-steal-the-moon-for-gravitational-waves/
tags:
...
[Astrobites post](https://astrobites.org/2026/05/23/were-going-to-steal-the-moon-for-gravitational-waves/)

## Abstract 
---
- [[GW|Gravitational Waves]] have been detected via [[LIGO]] as well as with [[pulsar timing arrays]], which use detection's high frequency(~100 hz range) and low freq (nano-hertz). 
...
- The moon could theoretically serve as a large detector, as [[GW]]s passing through would make it vibrate (or "ring") slightly. This could be detected easier then on earth, due to less background noise
- Authors seek to model and simulate this behavior

## Modeling 
---
- **Spectral Element Method (SEM):** High resolution numerical simulations that calculate how seismic waves propagate and interfere within the Moon when hit by [[GW]]s
