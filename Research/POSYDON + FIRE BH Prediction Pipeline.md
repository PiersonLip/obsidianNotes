...
- Then, move a snapshot forward, if in that time forward from the snapshot (most likely 15Myr), one of the stars assigned population has gone SNe into a BH figure out the middle point in the particle between the two simulations, save said x,y,v, and use that for later BH trajectori 
## Fitting Galore
---
