...
- $L_{jup} = (\frac{L_\odot}{r\pi a^2}(\pi R^2_{jup}A))$
...
- can find $p$ by looking at when the velocity pattern repeats
- we want $a_b$ and $M_B$. get $a_B$ from
- $$a_b^3 ≈ \frac{GM_AP^2}{4\pi^2}$$ $$M_A \gg M_B$$
...
- time before $t_1$ and $t_2$ yields planet radius or measuring the fraction of the starlight blocked (if $r_s$ is known)

#### Chance of detection

- Range of inclinations for which transit is observed
- $$\cos i \leq \frac{R_A+R_B}{a}$$
